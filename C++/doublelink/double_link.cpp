...
void int_test()
{
    ...
    pdlink->insert(20,0);        // 将 20 插入到第一个位置
    pdlink->insert_last(10);    // 将 10 追加到链表末尾
...
void string_test()
{
    ...
    pdlink->insert( sarr[1],0);        // 将 sarr中第2个元素 插入到第一个位置
    pdlink->insert_last(sarr[0]);    // 将 sarr中第1个元素  追加到链表末尾
...
void object_test()
{
    ...
    pdlink->insert(arr_stu[1],0);        // 将 arr_stu中第2个元素 插入到第一个位置
    pdlink->insert_last(arr_stu[0]);    // 将 arr_stu中第1个元素  追加到链表末尾
